...
if __name__ == '__main__':
    # test_dumps_and_loads()
    # test_dumps_and_loads_HIGHEST_PROTOCOL()
    # test_new_sytle_class()
    # test_dump_and_load_with_file()
    # read_file()
    # test_dump_and_load_with_file_HIGHEST_PROTOCOL()
    # test_dump_and_load_with_StringIO()
    test_pickler_unpickler()